...
BEGIN
  ...
  IF (:varCounter = 0) THEN
     varStatement := '';
  ELSE
     varStatement := 'CREATE JWT PROVIDER JWTPROVIDER_0C62F37C_95F5_42D7_A957_704F15080127_0C62F37C_95F5_42D7_A957_704F15080127 WITH ISSUER ''http://p2001017289trial.localhost:8080/uaa/oauth/token'' CLAIM ''user_name'' AS EXTERNAL IDENTITY';
     EXEC :varStatement;
  END IF;
END;
--
...
BEGIN
  ...
  IF (:varCounter = 0) THEN
     varStatement := '';
  ELSE
     varStatement := 'ALTER JWT PROVIDER JWTPROVIDER_0C62F37C_95F5_42D7_A957_704F15080127_0C62F37C_95F5_42D7_A957_704F15080127 SET ISSUER ''http://p2001017289trial.localhost:8080/uaa/oauth/token'' CLAIM ''user_name'' AS EXTERNAL IDENTITY';
     EXEC :varStatement;
  END IF;
END;
--
